...
public class Utils : MonoBehaviour {
	...
	public static Vector3 ScreenBoundsCheck(Bounds bnd, BoundsTest test = BoundsTest.center){
		...
		public static Vector3 BoundsInBoundsCheck ( Bounds bigB, Bounds lilB, BoundsTest test = BoundsTest.onScreen){
			...
			switch(test){
			//The center test determins what off (offset) would have to be applied to lil B tomove its center back inside BigB
			...
			case BoundsTest.onScreen:
				...
				//The offscreen test determines what off owuld need to be applid to move any tiny part of lil b inside of big B
